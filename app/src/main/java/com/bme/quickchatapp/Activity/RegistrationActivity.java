package com.bme.quickchatapp.Activity;
...
import com.bme.quickchatapp.R;
import com.bme.quickchatapp.ModelClass.Users;
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                if(imageUri!=null)
                                {
                                    ...
                                    String staus="Hey There I'm Using This Application";
                                    imageURI="https://firebasestorage.googleapis.com/v0/b/chat-bme.appspot.com/o/profile_image.png?alt=media&token=433976f5-4825-4d13-bb5d-2b64b63c9c49";
                                    Users users=new Users(auth.getUid(),name,email,imageURI,staus);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
